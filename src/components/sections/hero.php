...
<section id="hero" class="relative min-h-[90vh] flex items-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 w-full text-white py-20 fade-in">
        ...
        <h1 class="text-5xl md:text-8xl font-black leading-[0.9] mb-8">
            Votre indépendance <span class="text-green-500">énergétique</span><br>
            commence ici.
        </h1>
        ...
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="#contact" class="bg-white text-[#001c37] px-10 py-5 rounded font-bold uppercase text-sm hover:bg-green-500 hover:text-white transition-all text-center">
                Demander un devis
            </a>
            <a href="https://wa.me/22370707070?text=Bonjour,%20je%20souhaite%20en%20savoir%20plus%20sur%20vos%20solutions%20énergétiques" target="_blank" rel="noopener" class="bg-green-500 text-white px-10 py-5 rounded font-bold uppercase text-sm hover:bg-green-600 transition-all text-center flex items-center justify-center gap-2">
