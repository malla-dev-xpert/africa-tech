...
<section id="testimonials" class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4">
        ...
        <div class="grid md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-lg shadow-md slide-up">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-bold text-[#001c37]">Amadou Diallo</div>
                        <div class="text-sm text-gray-500">Entrepreneur, Bamako</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md slide-up">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-bold text-[#001c37]">Mariam Keita</div>
                        <div class="text-sm text-gray-500">Ancienne stagiaire</div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white p-8 rounded-lg shadow-md slide-up">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <div class="font-bold text-[#001c37]">Bakary Traoré</div>
                        <div class="text-sm text-gray-500">Directeur, Entreprise</div>
                    </div>
                </div>
            </div>
        </div>
