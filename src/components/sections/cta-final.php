...
<section id="cta-final" class="relative py-20 text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 text-center fade-in">
        ...
        <a href="https://wa.me/22370707070?text=Bonjour,%20je%20souhaite%20discuter%20de%20mon%20projet%20énergétique" target="_blank" rel="noopener" class="inline-block bg-yellow-400 text-white px-12 py-6 rounded-lg font-bold uppercase text-lg hover:bg-yellow-500 transition-all shadow-lg hover:shadow-xl">
