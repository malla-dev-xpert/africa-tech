<footer class="bg-[#001c37] text-gray-300">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    <a href="https://www.facebook.com" target="_blank" rel="noopener" class="text-gray-400 hover:text-yellow-400 transition-colors" aria-label="Facebook">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
                        </svg>
                    </a>
                    <a href="https://www.twitter.com" target="_blank" rel="noopener" class="text-gray-400 hover:text-yellow-400 transition-colors" aria-label="Twitter">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z" />
                        </svg>
                    </a>
                    <a href="https://www.instagram.com" target="_blank" rel="noopener" class="text-gray-400 hover:text-yellow-400 transition-colors" aria-label="Instagram">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a href="https://wa.me/22370707070" target="_blank" rel="noopener" class="text-gray-400 hover:text-yellow-400 transition-colors" aria-label="WhatsApp">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li class="flex items-start gap-3">
                        ...
                        <div>
                            <a href="tel:+22370707070" class="hover:text-yellow-400 transition-colors">+223 70 70 70 70</a><br>
                            <a href="tel:+22320202020" class="hover:text-yellow-400 transition-colors">+223 20 20 20 20</a>
                        </div>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-yellow-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <a href="mailto:contact@africa-tech.com" class="hover:text-yellow-400 transition-colors">contact@africa-tech.com</a>
                    </li>
                    <li class="flex items-start gap-3">
                        <svg class="w-5 h-5 text-yellow-400 mt-1 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <span>Faladie Sema<br>Bamako - Mali</span>
                    </li>
                </ul>
            </div>
        </div>
