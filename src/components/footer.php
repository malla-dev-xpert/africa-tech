        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
            ...
            <div>
                ...
                <div class="flex gap-4">
                    ...
                    <a href="https://www.tiktok.com/@africa.tech4?is_from_webapp=1&sender_device=pc" target="_blank" rel="noopener" class="text-gray-400 hover:text-yellow-400 transition-colors duration-300" aria-label="Tiktok">
                        <svg class="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
