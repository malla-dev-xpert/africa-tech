...
<section class="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 text-center text-white">
        <div class="flex items-center justify-center gap-2 mb-4">
            ...
            <span class="uppercase text-xs font-bold tracking-[0.2em] text-green-500">Nos produits</span>
            <span class="w-10 h-[2px] bg-green-500"></span>
        </div>
        <h1 class="text-4xl md:text-6xl font-black mb-4">Nos <span class="text-green-500">Produits</span></h1>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16 slide-up">
            <div class="flex items-center justify-center gap-2 mb-4">
                <span class="w-10 h-[2px] bg-green-500"></span>
                <span class="uppercase text-xs font-bold tracking-[0.2em] text-green-500">Catégories</span>
                <span class="w-10 h-[2px] bg-green-500"></span>
            </div>
            <h2 class="text-4xl md:text-5xl font-black text-[#001c37] mb-6">Gamme complète de <span class="text-green-500">produits</span></h2>
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div class="bg-gradient-to-br from-[#001c37] to-[#003366] rounded-xl p-8 text-white slide-up">
                ...
                <ul class="space-y-2 text-sm text-gray-300">
                    <li class="flex items-center gap-2">
                        <span class="text-green-500">✓</span> Garantie 25 ans
                    </li>
                    <li class="flex items-center gap-2">
                        <span class="text-green-500">✓</span> Certifiés IEC
                    </li>
                    <li class="flex items-center gap-2">
                        <span class="text-green-500">✓</span> Résistance aux intempéries
                    </li>
                </ul>
            </div>

            <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-xl p-8 text-white slide-up">
            ...
            <div class="bg-gray-50 rounded-xl p-8 slide-up border-2 border-gray-200">
                ...
                <ul class="space-y-2 text-sm text-gray-600">
                    <li class="flex items-center gap-2">
                        <span class="text-green-500">✓</span> Haute efficacité
                    </li>
                    <li class="flex items-center gap-2">
                        <span class="text-green-500">✓</span> Monitoring intelligent
                    </li>
                    <li class="flex items-center gap-2">
                        <span class="text-green-500">✓</span> Protection intégrée
                    </li>
                </ul>
            </div>
        </div>
...
<section class="py-20 bg-[#001c37] text-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16 slide-up">
            <h2 class="text-4xl md:text-5xl font-black mb-6">Spécifications <span class="text-green-500">techniques</span></h2>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white/10 backdrop-blur-sm p-8 rounded-xl slide-up">
                <div class="text-4xl font-black text-green-500 mb-2">25 ans</div>
            ...
            <div class="bg-white/10 backdrop-blur-sm p-8 rounded-xl slide-up">
                <div class="text-4xl font-black text-green-500 mb-2">24/7</div>
