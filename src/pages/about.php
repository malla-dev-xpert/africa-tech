...
<section class="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 text-center text-white">
        <div class="flex items-center justify-center gap-2 mb-4">
            ...
            <span class="uppercase text-xs font-bold tracking-[0.2em] text-yellow-400">Qui sommes-nous</span>
            <span class="w-10 h-[2px] bg-yellow-400"></span>
        </div>
        <h1 class="text-4xl md:text-6xl font-black mb-4">À propos de <span class="text-yellow-400">AFRICIA TECH</span></h1>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16 slide-up">
            <div class="flex items-center justify-center gap-2 mb-4">
                <span class="w-10 h-[2px] bg-yellow-400"></span>
                <span class="uppercase text-xs font-bold tracking-[0.2em] text-yellow-400">Nos valeurs</span>
                <span class="w-10 h-[2px] bg-yellow-400"></span>
            </div>
            <h2 class="text-4xl md:text-5xl font-black text-[#001c37] mb-6">Nos <span class="text-yellow-400">Valeurs</span></h2>
        </div>
...
<section class="py-20 bg-[#001c37] text-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16 slide-up">
            <div class="flex items-center justify-center gap-2 mb-4">
                <span class="w-10 h-[2px] bg-yellow-400"></span>
                <span class="uppercase text-xs font-bold tracking-[0.2em] text-yellow-400">Notre équipe</span>
                <span class="w-10 h-[2px] bg-yellow-400"></span>
            </div>
            <h2 class="text-4xl md:text-5xl font-black mb-6">Une équipe <span class="text-yellow-400">passionnée</span></h2>
...
<section class="py-20 bg-gradient-to-r from-[#001c37] to-[#003366] text-white">
    <div class="max-w-7xl mx-auto px-4 text-center fade-in">
        <h2 class="text-4xl md:text-5xl font-black mb-6">
            Rejoignez-nous dans la <span class="text-yellow-400">transition énergétique</span>
        </h2>
        <p class="text-xl text-gray-300 mb-12 max-w-2xl mx-auto">
            Ensemble, créons un avenir énergétique durable pour le Mali. Contactez-nous pour discuter de votre projet.
        </p>
        <a href="contact.php" class="inline-block bg-yellow-400 text-white px-12 py-6 rounded-lg font-bold uppercase text-lg hover:bg-yellow-500 transition-all shadow-lg hover:shadow-xl">
            Nous contacter
        </a>
    </div>
</section>
