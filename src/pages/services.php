...
<section class="relative h-[60vh] min-h-[400px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 text-center text-white">
        ...
        <h1 class="text-4xl md:text-6xl font-black mb-4">Nos <span class="text-green-500">Services</span></h1>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4">
        <div class="text-center mb-16 slide-up">
            <div class="flex items-center justify-center gap-2 mb-4">
                <span class="w-10 h-[2px] bg-green-500"></span>
                <span class="uppercase text-xs font-bold tracking-[0.2em] text-green-500">Notre processus</span>
                <span class="w-10 h-[2px] bg-green-500"></span>
            </div>
            <h2 class="text-4xl md:text-5xl font-black text-[#001c37] mb-6">Comment nous <span class="text-green-500">travaillons</span></h2>
        ...
        <div class="grid md:grid-cols-2 gap-12 items-center">
            <div class="slide-up">
                <div class="flex items-center gap-2 mb-4">
                    <span class="w-10 h-[2px] bg-green-500"></span>
                    <span class="uppercase text-xs font-bold tracking-[0.2em] text-green-500">Avantages</span>
                </div>
                <h2 class="text-4xl md:text-5xl font-black text-[#001c37] mb-6">Pourquoi choisir nos <span class="text-green-500">services</span></h2>
